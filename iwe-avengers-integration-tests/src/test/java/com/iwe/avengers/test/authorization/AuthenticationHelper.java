...
class AuthenticationHelper {
	 ...
	 *
	 * @param challenge
	 *            The authenticaion challange returned from the cognito user pool
	 * @param password
	 *            The password to be used to respond to the authentication
	 *            challenge.
	 * @return the Request created for the previous authentication challenge.
	 */
	public RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge, String password) {
	...
	final static class Hkdf {
		...
		/**
		 * @param algorithm
		 *            REQUIRED: The type of HMAC algorithm to be used.
		 */
		...
		/**
		 * @param ikm
		 *            REQUIRED: The input key material.
		 */
		 ...
		 *            REQUIRED: The input key material.
		 * @param salt
		 *            REQUIRED: Random bytes for salt.
		 */
